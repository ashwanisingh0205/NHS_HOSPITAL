...
const title = ref("Package Master List");
const endPoint = ref("/masters/items/package_master");
const params = ref({});
...
const columns = ref([
    ...
    { accessorKey: 'package_name', header: 'Package Name' },
    { id: 'action' }
]);
...
const filteredData = computed(() => {
    ...
    return data.value.filter(item =>
        ...
        item.package_code?.toLowerCase().includes(query)
    );
});
