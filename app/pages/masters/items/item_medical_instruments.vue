...
const title = ref("Item Medical Instruments List");
const endPoint = ref("/masters/items/medical_instruments");
const params = ref({});
...
const loadData = async () => {
    ...
    try {
        ...
        error.value = err.response?.data?.message || err.message || 'Failed to load item medical instruments';
    } finally {
        loading.value = false;
    }
};
