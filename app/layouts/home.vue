...
const navSections = {
    ...
    MIS: [
        ...
        { name :"OPD Queue", path: '/opd/opd_queue', icon: 'lucide:list-ordered'},
        { name :"IPD Help Desk", path: '/ipd/ipd_help_desk', icon: 'lucide:grid-2x2'},
        {name:"Lis Queue",path:"/lis/queue",icon:"lucide:list-ordered"},
        {name:"OT Register",path:"/ot/ot_register",icon:"lucide:grid-2x2"},
        {name:"help desk",path:"/insurance/desk/help_desk",icon:"lucide:grid-2x2"},
        {name:"Pre-auth",path:"/insurance/desk/pre_auth",icon:"lucide:grid-2x2"},
        {name:"Payments",path:"/insurance/desk/payments",icon:"lucide:grid-2x2"},
        {name:"Amc Tracker",path:"/store/bme/amc_tracker",icon:"lucide:grid-2x2"},
        {name:"Downtime",path:"/store/bme/downtime",icon:"lucide:grid-2x2"},
        {name:"Equipment Register",path:"/store/bme/equipments",icon:"lucide:grid-2x2"},
        {name:"Adjustment Register",path:"/store/purchase/adjustment_register",icon:"lucide:grid-2x2"},
        {name:"GRN Register",path:"/store/purchase/grn_register",icon:"lucide:grid-2x2"},
        {name:"Po Register",path:"/store/purchase/po_register",icon:"lucide:grid-2x2"},
        {name:"abc Analysis",path:"/store/reports/abc_analysis",icon:"lucide:grid-2x2"},
        {name:"consumption",path:"/store/reports/consumption",icon:"lucide:grid-2x2"},
        {name:"daily sales",path:"/store/reports/daily_sale",icon:"lucide:grid-2x2"},
        {name:"file report",path:"/store/reports/fido",icon:"lucide:grid-2x2"},
        {name:"sale report",path:"/store/sale/sale",icon:"lucide:grid-2x2"},
        {name:"Stock Transfer",path:"/store/sale/stock_transfer",icon:"lucide:grid-2x2"},
    ],
};
