...
// Field groups for form-edit
const fieldGroups = {
  basic: ['corporate_id', 'unit_id', 'category_id', 'form_type', 'form_code', 'form_name'],
  templates: [ 'button_theme','template_id', 'header_id', 'footer_id', 'css_id', 'letterhead_id'],
  communication: ['whatsapp_template_id', 'sms_template_id', 'email_template_id'],
  advanced: ['save_endpoint', 'workflow_ids', 'frequency', 'icon', 'status_pdf', 'status_universal']
}
